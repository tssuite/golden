...
- [Open golden the first time](#open-golden-the-first-time)
  ...
  - [Open golden with Vscode](#open-golden-with-vscode)
...
```bash
git clone https://github.com/tssuite/golden.git
```
